const items = [
  "PREFER TO BUILD IT YOURSELF? COACHING STARTS AT $700/HR",
  "STEP ONE: A FREE 20 MINUTE AI-DRIVEN AUDIT CALL WHERE WE FIND WHAT'S ACTUALLY COSTING YOU CUSTOMERS",
  "STEP TWO: A SYSTEM TAILORED TO YOUR BUSINESS THAT FIXES AND MARKETS EXACTLY WHAT STEP ONE FOUND",
  "STEP THREE: MORE PROFIT, MORE REPEAT CUSTOMERS, HOURS BACK IN YOUR WEEK",
]
