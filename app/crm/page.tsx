          ...
          <table style={{ width: "100%", borderCollapse: "collapse" }}>
            <thead>
              <tr style={{ background: "rgba(255,255,255,0.03)", borderBottom: "1px solid var(--hair)" }}>
                {["Name", "Business", "Contact", "Status", "Notes", "Created", ""].map((h) => (
            ...
            <tbody>
              {loading ? (
                <tr><td colSpan={7} style={{ padding: 48, textAlign: "center", color: "var(--ink-faint)" }}>
                ...
                <tr><td colSpan={7} style={{ padding: 64, textAlign: "center", color: "var(--ink-faint)", fontSize: 14 }}>
